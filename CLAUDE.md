...
- **Ne jamais ouvrir en entier** : les transcripts JSONL (`~/.claude/projects/*.jsonl`) et
  ...
  **régénérées à chaque scan** (`os.path.getsize`), plus à re-mesurer à la main :
  ...
  `docs/wiki.html` (458 Ko),
  `.claude/orchestration/runs.jsonl` (229 Ko),
  `.claude/orchestration/routing-hints.json` (159 Ko),
  `.claude/supervision/arbitrages.json` (154 Ko),
  `docs/wiki/technical/agents-supervision.md` (150 Ko).
