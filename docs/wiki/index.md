...
- **Skills projet sans usage** : `agent-orchestrator`, `deck-design-library`, `pptx-framed-image`, `slide-text-polish`, `veille-agentic` — vérifier pertinence et déclencheurs.
