...
- **Skills projet sans usage** : `agent-orchestrator`, `agent-supervisor`, `deck-design-library`, `pptx-framed-image`, `slide-text-polish` — vérifier pertinence et déclencheurs.
