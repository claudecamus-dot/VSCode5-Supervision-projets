...
_Généré le 2026-07-31 15:34 par `scripts/scan_projets.py` — ne pas éditer à la main._

## Poste de pilotage

**6 projets** · **1 en alerte** (VSCode2 🟠 majeur) · **5 pratique(s) en écart** · **2 finding(s) ouvert(s)** · **3 run(s) à solder** · **0 retard(s) de cadence**

_Depuis le scan précédent (2026-07-31 15:27) : pratiques en écart, findings, runs à solder (+1), retards._
...
- [VScode5] il y a 0 min — Mettre en place le systeme de table ronde, corriger le test instable, relancer le supervis
...
| --- | --- | --- | --- |
| VSCode | il y a 0 min | il y a 4 j | il y a 22 h |
| VSCode1 | il y a 0 min | il y a 3 j | il y a 3 h |
| VSCode2 | il y a 0 min | il y a 2 j | il y a 3 h |
| VSCode3 | il y a 0 min | il y a 8 j | il y a 23 h |
| VSCode4 | il y a 0 min | il y a 7 j | il y a 21 h |
| VScode5 | il y a 0 min | il y a 1 j | il y a 46 min |
...
Dernier scan superviseur local : 2026-07-31T15:34:33+02:00
...
**Skills utilisés** (10) : agent-orchestrator (93), agent-supervisor (10), audit-technique (5), revue-increment (4), veille-agentic (2), bmad-party-mode (2), update-config (1), run (1), bmad-customize (1), dataviz (1)
...
**Sous-agents utilisés** : general-purpose (41), Explore (15), agent-supervisor (2), bmad-revue (2), bmad-recherche (1)

**Playbooks** : dev-verifie, evolution-flotte, export-ppt-verifie, revue-design-parallele

**Runs d'orchestration** : 63 (en-attente-validation ×2, partiel ×1, succes ×60)
...
| VScode5 | 🟢 18 fichier(s) de test, coverage configuré | 🟢 2 test(s) à vérification réelle | 🟢 hook pré-commit, bmad-code-review | 🟢 skill + hook SessionStart | ⚪ ne produit pas de deck | 🟢 README+usage, wiki+html, CLAUDE.md | 🟢 persona, why, besoins, valeur + brief BMAD | 🟢 linter, CI, CLAUDE.md, conventions, discipline tokens | 🟢 deny rules, guard git |
