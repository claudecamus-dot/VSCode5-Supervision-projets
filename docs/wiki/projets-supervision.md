...
_Généré le 2026-09-01 08:47 par `scripts/scan_projets.py` — ne pas éditer à la main._

## Poste de pilotage

**6 projets** · **1 en alerte** (VScode5 🟠 majeur) · **7 pratique(s) en écart** · **4 finding(s) ouvert(s)** · **9 run(s) à solder** · **7 retard(s) de cadence**

_Depuis le scan précédent (2026-09-01 08:40) : pratiques en écart, findings, runs à solder, retards._
...
- [VScode5] il y a 21 h — Applique tout cela : les 9 findings de la revue adversariale, les 4 trouvailles de veille,
- [VScode5] il y a 19 h — 1-rendre /orchestre utilisable sur VSCode1-4 ; 2-expliciter les 2 activations en attente ;
- [VScode5] il y a 18 h — 1-appliquer les 2 activations ; 2-phase d amelioration de la generation PDF de qualite au 
...
- [VSCode4] il y a 11 h — Traiter le trou du contrat de tests au hub + questionnaire lineaire (pas de saut) : slides
- [VScode5] il y a 39 min — relance les travaux de la derniere session
...
| VSCode2 | il y a 0 min | il y a 22 h | il y a 10 h |
| VSCode3 | il y a 0 min | 🟠 il y a 40 j | 🟠 il y a 32 j |
| VSCode4 | il y a 0 min | 🟠 il y a 39 j | il y a 11 h |
| VScode5 | il y a 0 min | il y a 19 h | il y a 24 min |
...
Dernier scan superviseur local : 2026-09-01T08:47:05+02:00
...
**Sous-agents utilisés** : general-purpose (48), Explore (30), bmad-revue (7), claude (4), Plan (3), claude-code-guide (1)
...
| VScode5 | 🟢 36 fichier(s) de test, coverage configuré | 🟢 7 test(s) à vérification réelle | 🟢 hook pré-commit, bmad-code-review | 🟢 skill + hook SessionStart | 🟠 deck-design-library | 🟢 README+usage, wiki+html, CLAUDE.md | 🟢 persona, why, besoins, valeur + brief BMAD | 🟢 linter, CI, CLAUDE.md, conventions, discipline tokens | 🟢 deny rules, guard git |
