...
_Généré le 2026-09-01 10:09 par `scripts/scan_projets.py` — ne pas éditer à la main._

## Poste de pilotage

**6 projets** · **0 en alerte** (—) · **7 pratique(s) en écart** · **3 finding(s) ouvert(s)** · **12 run(s) à solder** · **4 retard(s) de cadence**

_Depuis le scan précédent (2026-09-01 09:48) : pratiques en écart, findings, runs à solder (+1), retards._
...
- [VScode5] il y a 23 h — Revue du projet (hub) puis creation du repertoire export/ : deployer les dernieres version
...
- [VSCode2] il y a 17 h — Revue du projet + analyse de la partie enregistrement libre audio (perimetre resserre sur 
...
- [VScode5] il y a 2 h — relance les travaux de la derniere session
- [VScode5] il y a 57 min — lance tous ces chantiers, puis : contrats des salles, 2 salles neuves (inspection critique
- [VSCode2] il y a 55 min — Relance des travaux de la derniere session (traitement des 12 constats R3 : verifier, fair
- [VScode5] il y a 19 min — propagation du socle vers les 5 depots, salle observatoire, choix langage et environnement
...
| VSCode1 | il y a 0 min | 🟠 il y a 34 j | il y a 0 min |
| VSCode2 | il y a 0 min | il y a 23 h | il y a 0 min |
| VSCode3 | il y a 0 min | 🟠 il y a 40 j | il y a 0 min |
| VSCode4 | il y a 0 min | 🟠 il y a 39 j | il y a 0 min |
| VScode5 | il y a 0 min | il y a 20 h | il y a 19 min |
...
| VScode5 | 🌐 [wiki.html](file:///C:/Users/claude.camus/Documents/VScode5 - Supervision projets/docs/wiki.html) | 6.10.0 (core+bmm) | 55 | 8 | 4 | ✅ | ✅ | PostToolUse, PreToolUse, SessionStart, UserPromptSubmit | ✅ |
...
Dernier scan superviseur local : 2026-09-01T10:09:39+02:00
...
**Runs d'orchestration** : 90 (en-attente-validation ×8, partiel ×3, succes ×79)
...
| VScode5 | 🟢 39 fichier(s) de test, coverage configuré | 🟢 7 test(s) à vérification réelle | 🟢 hook pré-commit, bmad-code-review | 🟢 skill + hook SessionStart | 🟠 deck-design-library | 🟢 README+usage, wiki+html, CLAUDE.md | 🟢 persona, why, besoins, valeur + brief BMAD | 🟢 linter, CI, CLAUDE.md, conventions, discipline tokens | 🟢 deny rules, guard git |
