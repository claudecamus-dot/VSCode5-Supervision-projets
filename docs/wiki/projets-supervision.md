...
_Généré le 2026-07-30 10:56 par `scripts/scan_projets.py` — ne pas éditer à la main._

## Poste de pilotage

**6 projets** · **1 en alerte** (VSCode2 🟠 majeur) · **15 pratique(s) en écart** · **2 finding(s) ouvert(s)** · **1 run(s) à solder** · **0 retard(s) de cadence**
...
- 🟠 VSCode3 : 3 pratique(s) en écart
- 🟠 VSCode1 : 1 pratique(s) en écart

**Runs `en-attente-validation` à solder** (valider ou requalifier) :
- [VScode5] il y a 14 h — Corriger 1) les ecarts entre indicateurs au vert et actions correctives affichees 2) la le
...
| --- | --- | --- | --- |
| VSCode | il y a 0 min | il y a 2 j | il y a 23 h |
| VSCode1 | il y a 0 min | il y a 1 j | il y a 14 h |
| VSCode2 | il y a 0 min | il y a 23 h | il y a 10 h |
| VSCode3 | il y a 0 min | il y a 7 j | il y a 10 min |
| VSCode4 | il y a 0 min | il y a 6 j | il y a 3 min |
| VScode5 | il y a 0 min | il y a 39 min | il y a 14 h |
...
Dernier scan superviseur local : 2026-07-30T10:56:17+02:00
...
Dernier scan superviseur local : 2026-07-30T10:56:19+02:00
...
Dernier scan superviseur local : 2026-07-30T10:56:23+02:00
...
Dernier scan superviseur local : 2026-07-30T10:56:25+02:00
...
Dernier scan superviseur local : 2026-07-30T10:56:27+02:00

**Skills utilisés** (7) : agent-orchestrator (90), agent-supervisor (10), audit-technique (5), veille-agentic (2), update-config (1), revue-increment (1), run (1)
...
| VSCode2 | 🟢 41 fichier(s) de test, coverage configuré | 🟢 25 test(s) à vérification réelle | 🟢 hook pré-commit, bmad-code-review | 🟢 skill + hook SessionStart | 🟢 deck-design-review, deck-design-library | 🟢 README+usage, wiki+html, CLAUDE.md | 🟢 persona, why, besoins + brief BMAD | 🟢 linter, CI, CLAUDE.md ⚠ 152 l (> 150 — élaguer), conventions | 🟢 .env gitigné, deny rules, guard git |
| VSCode3 | 🟢 4 fichier(s) de test, coverage configuré | 🟢 2 test(s) à vérification réelle | 🟢 hook pré-commit, bmad-code-review | 🟢 skill + hook SessionStart | 🟢 deck-design-review, deck-design-library, ppt-designer | 🟠 wiki+html, CLAUDE.md | 🟢 persona, why, besoins, valeur + brief BMAD | 🟢 linter, CLAUDE.md, conventions | 🟢 deny rules, guard git |
| VSCode4 | 🟠 1 fichier(s) de test, coverage configuré | 🟠 1 test(s) à vérification réelle | 🟢 hook pré-commit, bmad-code-review | 🟢 skill + hook SessionStart | 🟢 deck-design-review, deck-design-library, ppt-designer | 🟠 wiki+html, CLAUDE.md | 🟢 persona, why, besoins, valeur + brief BMAD | 🟠 linter, CLAUDE.md | 🟢 .env gitigné, deny rules, guard git |
| VScode5 | 🟢 12 fichier(s) de test, coverage configuré | 🟢 2 test(s) à vérification réelle | 🟢 hook pré-commit, bmad-code-review | 🟢 skill + hook SessionStart | ⚪ ne produit pas de deck | 🟢 README+usage, wiki+html, CLAUDE.md | 🟢 persona, why, besoins, valeur + brief BMAD | 🟢 linter, CI, CLAUDE.md, conventions | 🟢 deny rules, guard git |
